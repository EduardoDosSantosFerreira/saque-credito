      ...
      <div
          ...
          <div class="px-8 py-12">
            <div class="relative w-24 h-24 mx-auto">
              <img class="relative object-cover w-24 h-24 mx-auto rounded-full"
                src="https://cdn.rareblocks.xyz/collection/celebration/images/testimonials/1/avatar-1.jpg" alt="" />
            ...
            <blockquote class="mt-7">
              <p class="text-lg text-black">Atendimento ótimo, já virei cliente 😍
                Atendente Raylanda então é uma das melhores daí. Estão de parabéns 👏🏽👏🏽</p>
            </blockquote>
            <p class="text-base font-semibold tex-tblack mt-9">Raquel Nikawa</p>
            <p class="mt-1 text-base text-gray-600">Investidora</p>
          </div>
        </div>
        ...
        <div class="overflow-hidden bg-white rounded-md shadow">
          <div class="px-8 py-12">
            <div class="relative w-24 h-24 mx-auto">
              <img class="relative object-cover w-24 h-24 mx-auto rounded-full"
                src="https://cdn.rareblocks.xyz/collection/celebration/images/testimonials/1/avatar-2.jpg" alt="" />
              <div class="absolute top-0 right-0 flex items-center justify-center bg-green-600 rounded-full w-7 h-7">
                <svg class="w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  fill="currentColor">
                  <path
            ...
            <blockquote class="mt-7">
              <p class="text-lg text-black">Gostei da experiência , simples facil , fiz o empréstimo no cartão recebi em
                10 minutos. Empresa confiavel</p>
            </blockquote>
            <p class="text-base font-semibold tex-tblack mt-9">Roberto Alves</p>
            <p class="mt-1 text-base text-gray-600">Designer</p>
          </div>
        </div>
        ...
        <div class="overflow-hidden bg-white rounded-md shadow">
          <div class="px-8 py-12">
            <div class="relative w-24 h-24 mx-auto">
              <img class="relative object-cover w-24 h-24 mx-auto rounded-full"
                src="https://cdn.rareblocks.xyz/collection/celebration/images/testimonials/1/avatar-3.jpg" alt="" />
              <div class="absolute top-0 right-0 flex items-center justify-center bg-green-600 rounded-full w-7 h-7">
                <svg class="w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                  fill="currentColor">
                  <path
            ...
            <p class="mt-1 text-base text-gray-600">Secretária</p>
          </div>
        </div>
      </div>
    </div>
